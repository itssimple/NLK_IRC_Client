            ...
            <Layout style={{minHeight: '100vh'}}>
                <Layout>
                    <Sider width={200} style={{background: '#cecece', minHeight: '100%', padding: '5px'}}>
                        <Button onClick={this.connectToServer} block><Icon type="login" theme="outlined" /> Connect</Button><br />
                        <Button onClick={this.disconnect} block><Icon type="logout" theme="outlined" /> Disconnect</Button><br />
                        <Button onClick={this.logMenu} block>Pewpew</Button>
                    </Sider>
